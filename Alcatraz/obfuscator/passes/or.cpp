...
// OR a, b  →  push b; not a; not b; and a, b; not a; pop b; test a, a
// De Morgan: ~(~a & ~b) = a | b, pop restores b, test fixes flags
bool obfuscator::obfuscate_or(std::vector<obfuscator::function_t>::iterator& function, std::vector<obfuscator::instruction_t>::iterator& instruction) {
