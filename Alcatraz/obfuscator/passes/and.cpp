...
// AND a, b  →  not a; not b; or a, b; not a; not b
// De Morgan: ~(~a | ~b) = a & b, final not b restores b
bool obfuscator::obfuscate_and(std::vector<obfuscator::function_t>::iterator& function, std::vector<obfuscator::instruction_t>::iterator& instruction) {
